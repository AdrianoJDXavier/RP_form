...
function MakeTexto(chars) {
    var subjects = ["O s'ist'ema", "A equ'ip'e", "O s'up'orte", "O cl'ie'nte", "A fu'n'cionali'dade", "O ser'v'idor"],
        verbs = ["reso'lveu", "t'estou", "su'por'tou", "des'conside'rou", "impl'em'entou", "execut'ou"],
        objects = ["o pr'oblema", "um tes'te", "o se'rviço", "a sol'ução", "a ta'refa", "o pro'cedim'ento"],
        connectors = ["e", "ma's", "por'que", "enq'uanto", "por'tanto", "po'rém"],
        pontuacao = [".", ",", ";"],
        text = "",
        phrase,
        punc,
